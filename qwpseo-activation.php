...
function qwpseo_hide_notice(){ jQuery('#qwpseo_notice_meta_fix').addClass('hidden'); }
...
<?php
	...
	printf(qtranxf_translate('Plugin %s needs to perform an update of the database in order to function correctly.'), '<span style="color:red;"><a href="https://wordpress.org/plugins/wp-seo-qtranslate-x/" target="_blank"><strong>Integration: Yoast SEO & qTranslate-X</strong></a></span>');
	echo '&nbsp;';
